...
async def handle_help(ctx: CommandContext, _args: str) -> str | None:
...
async def handle_status(ctx: CommandContext, _args: str) -> str | None:
    ...
    try:
        ...
        estimated, _source = ctx.memory_consolidator.estimate_session_prompt_tokens(session)
    except Exception:
        estimated = 0
