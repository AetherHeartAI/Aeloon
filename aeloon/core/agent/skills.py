...
BUILTIN_SKILLS_DIR = Path(__file__).parent.parent.parent / "resources" / "skills"
...
class SkillsLoader:
    ...
    def _parse_aeloon_metadata(self, raw: str) -> dict:
    ...
    def _get_skill_meta(self, name: str) -> dict:
        """Get aeloon metadata for a skill (cached in frontmatter)."""
