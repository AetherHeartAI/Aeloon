...
- do not rely on `memory/HISTORY.md`; it is retired from runtime behavior
- only inspect `HISTORY.md` when the user explicitly asks for that file or you are auditing legacy artifacts
